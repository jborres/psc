<?php
    ...
    if(!$_SESSION['eMail']){
        ...
        if(isset($_GET['id'])){
            ...
            $delete = "delete from memberRegistry where user_id='$get_id'";
...
<body>
    <div class="container">
        <header align='center'>
            <font face='HELVETICA' style="font-size: 50px;">MEMBER USERS</font><br><br>
        </header>
        <table align='center'>
            <tr>
                <th>S.N.</th>
            ...
            <?php
                $sel = "select * from memberRegistry";
            ...
            <tr align='center'>
                ...
                <td><a href="editMemberRegistry.php?id=<?php echo $id;?>"><img src="logo/edit.png" width="30" height="30"></a></td>
                <td><a href="memberUser.php?id=<?php echo $id;?>"><img src="logo/delete.png" width="30" height="30"></a></td>
                <td><a href="makeAdmin.php?id=<?php echo $id;?>"><img src="logo/move_01.png" width="30" height="30"></a></td>
