<?php
	...
	if(isset($_POST['cancel'])){
		header("location: memberUser.php");
	}
    else{
...
<nav>
	...
	<form action="editMemberRegistry.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
		<table align="center">
			<tr>
...
<?php
	...
	if(isset($_POST['upDate'])){
		...
		if($passWord=='' OR $confirmPass=='' OR $passWord!=$confirmPass OR strlen($passWord)<8){
			...
			$update = "update memberRegistry set firstName='$firstName',familyName='$familyName',passWord='$passWord',confirmPassword='$confirmPass',eMail='$eMail',aGe='$aGe',genDer='$genDer',birthDay='$birthDay' where user_id='$edit_id'";
